...
func NewPutSingleChoiceGroupIDParams() PutSingleChoiceGroupIDParams {
	...
	return PutSingleChoiceGroupIDParams{}
}

// PutSingleChoiceGroupIDParams contains all the bound params for the put single choice group ID operation
...
func (o *PutSingleChoiceGroupIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PutSingleChoiceGroupIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
