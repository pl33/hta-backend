...
func (o *GetSingleChoiceGroupIDURL) WithBasePath(bp string) *GetSingleChoiceGroupIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetSingleChoiceGroupIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetSingleChoiceGroupIDURL")
	}
...
func (o *GetSingleChoiceGroupIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSingleChoiceGroupIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSingleChoiceGroupIDURL")
	}
