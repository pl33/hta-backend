...
func NewPostSingleChoiceGroupGroupIDSingleChoiceParams() PostSingleChoiceGroupGroupIDSingleChoiceParams {
	...
	return PostSingleChoiceGroupGroupIDSingleChoiceParams{}
}

// PostSingleChoiceGroupGroupIDSingleChoiceParams contains all the bound params for the post single choice group group ID single choice operation
...
func (o *PostSingleChoiceGroupGroupIDSingleChoiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CategorySingleChoice
...
func (o *PostSingleChoiceGroupGroupIDSingleChoiceParams) bindGroupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
