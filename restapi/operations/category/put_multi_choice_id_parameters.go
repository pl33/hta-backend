...
func NewPutMultiChoiceIDParams() PutMultiChoiceIDParams {
	...
	return PutMultiChoiceIDParams{}
}

// PutMultiChoiceIDParams contains all the bound params for the put multi choice ID operation
...
func (o *PutMultiChoiceIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
