...
func (o *DeleteSingleChoiceGroupIDURL) WithBasePath(bp string) *DeleteSingleChoiceGroupIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteSingleChoiceGroupIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteSingleChoiceGroupIDURL")
	}
...
func (o *DeleteSingleChoiceGroupIDURL) String() string {
...
func (o *DeleteSingleChoiceGroupIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteSingleChoiceGroupIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteSingleChoiceGroupIDURL")
	}
