...
func (o *DeleteMultiChoiceIDURL) WithBasePath(bp string) *DeleteMultiChoiceIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteMultiChoiceIDURL) Build() (*url.URL, error) {
	...
	var _path = "/multi_choice/{id}"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on DeleteMultiChoiceIDURL")
	}
...
func (o *DeleteMultiChoiceIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteMultiChoiceIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteMultiChoiceIDURL")
	}
