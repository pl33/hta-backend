...
func NewDeleteSingleChoiceGroupIDParams() DeleteSingleChoiceGroupIDParams {
	...
	return DeleteSingleChoiceGroupIDParams{}
}

// DeleteSingleChoiceGroupIDParams contains all the bound params for the delete single choice group ID operation
...
func (o *DeleteSingleChoiceGroupIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteSingleChoiceGroupIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
