...
func NewGetSingleChoiceGroupIDParams() GetSingleChoiceGroupIDParams {
	...
	return GetSingleChoiceGroupIDParams{}
}

// GetSingleChoiceGroupIDParams contains all the bound params for the get single choice group ID operation
...
func (o *GetSingleChoiceGroupIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetSingleChoiceGroupIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
