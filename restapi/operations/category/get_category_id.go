...
type GetCategoryIDHandlerFunc func(GetCategoryIDParams, *models.User) middleware.Responder

// Handle executing the request and returning a response
func (fn GetCategoryIDHandlerFunc) Handle(params GetCategoryIDParams, principal *models.User) middleware.Responder {
	return fn(params, principal)
}

// GetCategoryIDHandler interface for that can handle valid get category ID params
type GetCategoryIDHandler interface {
	Handle(GetCategoryIDParams, *models.User) middleware.Responder
}
