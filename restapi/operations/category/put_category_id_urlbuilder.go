...
func (o *PutCategoryIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on PutCategoryIDURL")
	}
...
func (o *PutCategoryIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutCategoryIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutCategoryIDURL")
	}
