...
func NewPutSingleChoiceIDParams() PutSingleChoiceIDParams {
	...
	return PutSingleChoiceIDParams{}
}

// PutSingleChoiceIDParams contains all the bound params for the put single choice ID operation
...
func (o *PutSingleChoiceIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
