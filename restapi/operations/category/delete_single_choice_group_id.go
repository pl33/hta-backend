...
func NewDeleteSingleChoiceGroupID(ctx *middleware.Context, handler DeleteSingleChoiceGroupIDHandler) *DeleteSingleChoiceGroupID {
	return &DeleteSingleChoiceGroupID{Context: ctx, Handler: handler}
}
...
func (o *DeleteSingleChoiceGroupID) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewDeleteSingleChoiceGroupIDParams()
