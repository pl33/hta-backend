...
func NewGetMultiChoiceIDParams() GetMultiChoiceIDParams {
	...
	return GetMultiChoiceIDParams{}
}

// GetMultiChoiceIDParams contains all the bound params for the get multi choice ID operation
...
func (o *GetMultiChoiceIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
