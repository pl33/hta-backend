...
func NewGetSingleChoiceIDParams() GetSingleChoiceIDParams {
	...
	return GetSingleChoiceIDParams{}
}

// GetSingleChoiceIDParams contains all the bound params for the get single choice ID operation
...
func (o *GetSingleChoiceIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
